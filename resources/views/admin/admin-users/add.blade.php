            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-lg-row">
                    <div class="flex-lg-row-fluid me-0">
                        <form class="form" method="post" id="kt_modal_add_admin_user_form" action="{{ route('admin.admin-users.createProcess') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="fv-row" style="text-align: right;">
                                        <input id="uploaded_by" type="hidden" name="uploaded_by" value="admin_panel" readonly />
