    ...
    <div id="kt_content_container" class="container-sm">
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <?php
                if( isset($user_id) && $user_id != '' && $user_id != 'all' && $user_id > 0 ) {?>
                    <form class="form" method="post" id="kt_modal_add_user_form" action="{{ route('admin.tasks.createProcess') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="flex-lg-row-fluid me-0">
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="fv-row">
                                                <input type="text" name="start_date" id="start_date" value="" class="daterange-single form-control" placeholder="<?php echo getDatePlaceholder();?>" autocomplete="off">
                                            </div>
                                            @error('name')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                                    ...
                                                    <?php
                                                        if( isset($task_types) && $task_types != '' && count($task_types) > 0) {
                                                            foreach ($task_types as $key => $task_type) {
                                                                $selected = (old('purpose') == $task_type->id) ? 'selected' : '';?>
