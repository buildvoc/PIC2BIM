            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 custom-table" id="kt_table_users_list">
                <thead>
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th>Tasks count</th>
                        <th>Photos count</th>
                        <th>Unassigned photos</th>
                        <th>Tasks in Data provided</th>
                        <th>Action</th>
                    </tr>
                </thead>
    ...
    $(function() {
        table = $('#kt_table_users_list').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'Unassigned_photos',
                    name: 'Unassigned_photos',
                },
                {
                    data: 'Tasks_in_Data_provided',
                    name: 'Tasks_in_Data_provided',
                },
                {
                    data: 'Action',
                    name: 'Action',
