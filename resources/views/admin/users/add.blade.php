    ...
    <div id="kt_content_container" class="container-sm">
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <form class="form" method="post" id="kt_modal_add_user_form" action="{{ route('admin.users.createProcess') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="flex-lg-row-fluid me-0">
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row fv-plugins-icon-container">
                                        <label class="required fs-7 fw-bold mt-3">Password</label>
                                        <div class="fv-row">
                                    ...
                                    <div class="col-md-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="fv-row">
                                            <input type="text" name="identification_number" id="identification_number" class="form-control" value="{{old('identification_number')}}">
                                        </div>
