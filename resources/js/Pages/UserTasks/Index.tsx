...
export default function UserTasks({ auth }: PageProps) {
  ...
  function applyFilters(params : {search : string;sortColumn : string;sortOrder : string;filters : string[]}){
    ...
    router.get(route('user-tasks.index')+'?'+queryString);
  }
