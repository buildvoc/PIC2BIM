...
export function Index({ auth }: PageProps) {
    ...
    const [filter_tasks_photos, set_filter_tasks_photos] =
        useState<Array<TaskPhotos>>(tasksPhotos);
    ...
    const handleSelectedStatus = (status: string) => {
        setSelectedStatus((prevSelectedStatus) => {
            if (prevSelectedStatus.includes(status)) {
                const return1 = prevSelectedStatus.filter(
