...
function Dashboard({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight", children: "Agencies" }),
      children: [
                  ...
                  renderCell: (row) => /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx(
                      Link,
                      {
                        ...
                        children: /* @__PURE__ */ jsx(FontAwesomeIcon, { icon: faEye })
                      }
                    ),
                    /* @__PURE__ */ jsx(
                      Link,
