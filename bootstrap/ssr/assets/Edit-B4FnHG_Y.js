...
function Edit({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight", children: "Task Type - management" }),
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "max-w-2xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold", children: "Edit Purpose" })
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto bg-white dark:bg-gray-800 overflow-hidden rounded shadow", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
            /* @__PURE__ */ jsx("div", { className: "grid gap-8 px-8 py-4", children: /* @__PURE__ */ jsx(FieldGroup, { required: true, label: "Name", name: "name", error: errors.name, children: /* @__PURE__ */ jsx(
              TextInput,
              {
                name: "name",
                error: errors.name,
            ...
            /* @__PURE__ */ jsx("div", { className: "grid gap-8 px-8 py-4", children: /* @__PURE__ */ jsx(FieldGroup, { label: "Description", name: "description", error: errors.description, children: /* @__PURE__ */ jsx(
              TextInput,
              {
                name: "description",
